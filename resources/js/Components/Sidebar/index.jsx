              ...
              <span>
                <span className="sidebar-icon">
                  <svg
                    ...
                    height="18"
                    fill="currentColor"
                    className="bi bi-bookmarks icon icon-xs me-2"
                    viewBox="0 0 16 16"
                  >
              ...
              <span>
                <span className="sidebar-icon">
                  <svg
                    ...
                    height="18"
                    fill="currentColor"
                    className="bi bi-back icon icon-xs me-2"
                    viewBox="0 0 16 16"
                  >
              ...
              <span>
                <span className="sidebar-icon">
                  <svg
                    ...
                    height="18"
                    fill="currentColor"
                    className="bi bi-people-fill icon icon-xs me-2"
                    viewBox="0 0 16 16"
                  >
              ...
              <span>
                <span className="sidebar-icon">
                  <svg
                    ...
                    height="18"
                    fill="currentColor"
                    className="bi bi-stopwatch icon icon-xs me-2"
                    viewBox="0 0 16 16"
                  >
